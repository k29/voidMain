...
private:
	...
	static const double forwardTiltCorrection = 1.3;	//correction in degrees
...
public:
	...
	int tempLandmarkPixelX[10];
	int tempLandmarkPixelNum;
	int tempnLand;
	...
	std::vector<WhiteBlob> whiteBlobList;
	// int nLand;
	Coords ball;
