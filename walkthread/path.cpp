...
PathReturns Path::path_return(PathStructure ps)
{
	...
	obstacle[NO_OF_OBSTACLES+2].y= OBSTACLE_RADIUS;
	obstacle[NO_OF_OBSTACLES+2].obstacle_id=-2;
	obstacle[NO_OF_OBSTACLES+2].type= CIRCLE;
	cvCircle(image, cvPoint(obstacle[NO_OF_OBSTACLES+2].x+200, obstacle[NO_OF_OBSTACLES+2].y+200),  ORIENTATION_RADIUS, cvScalar(255,0,0)); 

	obstacle[NO_OF_OBSTACLES+3].obstacle_radius= OBSTACLE_RADIUS;
	obstacle[NO_OF_OBSTACLES+3].x= 0;
	obstacle[NO_OF_OBSTACLES+3].y= -OBSTACLE_RADIUS;
	obstacle[NO_OF_OBSTACLES+3].obstacle_id=-2;
	obstacle[NO_OF_OBSTACLES+3].type= CIRCLE;
	cvCircle(image, cvPoint(obstacle[NO_OF_OBSTACLES+3].x+200, obstacle[NO_OF_OBSTACLES+3].y+200),  ORIENTATION_RADIUS, cvScalar(255,0,0)); 
...
//implementing circle design
	...
	for(int i=0;i<NO_OF_OBSTACLES+4;i++)
	{
		...
		{
			for (int j = i; j < NO_OF_OBSTACLES-1+4; ++j)
			{
...
void Path::updatePathPacket(PathPacket &pathpackvar)
{
