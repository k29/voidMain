...
public:
	Motor(MotorType motorType, int id, Communication* comm,int offsetValue = 0, int dMode = 0, int zeroPos = 2048, int complianceSlope = 32, int complianceMargin = 1, int compliancePunch = 32, int pidGainP = 32, int pidGainI = 0, int pidGainD = 0);
