...
void loop() 
{
  ...
  {
    assignment();
    Serial.println(enable_right);
    Serial.println(enable_front);
    Serial.println(sqrt((enable_right)*(enable_right)+(enable_front)*(enable_front)));
    if(theta!=90&&theta!=270)
    {
      time=r/(sqrt((enable_right)*(enable_right)+(enable_front)*(enable_front)));
    }
    else
    {
      time=r/vmax;
...
{                   // Viewing from motor to wheels
  if(theta<=45&&theta>=0)  // Ist Quad
  {
    enable_front=vmax;
    enable_back=vmax;
    enable_right=((vmax-180)*tan(theta*3.14/180))+180;
    enable_left=((vmax-180)*tan(theta*3.14/180))+180;
    inp1_front=1;
    inp2_front=0;
    inp1_back=0;
    inp2_back=1;
  ...
  if(theta>45&&theta<=90)  // Ist Quad
  {
    enable_right=vmax;
    enable_left=vmax;
    enable_front=((vmax-180)*tan((90-theta)*3.14/180))+180;
    enable_back=((vmax-180)*tan((90-theta)*3.14/180))+180;
    inp1_front=1;
    inp2_front=0;
    inp1_back=0;
    inp2_back=1;
  ...
  if(theta>90&&theta<=135)  // IInd Quad
  {
    enable_right=vmax;
    enable_left=vmax;
    enable_front=((vmax-180)*tan((theta-90)*3.14/180))+180;
    enable_back=((vmax-180)*tan((theta-90)*3.14/180))+180;
    inp1_front=0;
    inp2_front=1;
    inp1_back=1;
    inp2_back=0;
  ...
  if(theta>135&&theta<=180)  // IInd Quad
  {
    enable_front=vmax;
    enable_back=vmax;
    enable_right=((vmax-180)*tan((180-theta)*3.14/180))+180;
    enable_left=((vmax-180)*tan((180-theta)*3.14/180))+180;
    inp1_front=0;
    inp2_front=1;
    inp1_back=1;
    inp2_back=0;
  ...
  if(theta>180&&theta<=225)  //  IIIrd Quad
  {
    enable_front=vmax;
    enable_back=vmax;
    enable_right=((vmax-180)*tan((theta-180)*3.14/180))+180;
    enable_left =((vmax-180)*tan((theta-180)*3.14/180))+180;
    inp1_front=0;
    inp2_front=1;
    inp1_back=1;
    inp2_back=0;
  ...
  if(theta>225&&theta<=270)  //  IIIrd Quad
  {
    enable_right=vmax;
    enable_left=vmax;
    enable_front=((vmax-180)*tan((270-theta)*3.14/180))+180;
    enable_back=((vmax-180)*tan((270-theta)*3.14/180))+180;
    inp1_front=0;
    inp2_front=1;
    inp1_back=1;
    inp2_back=0;
  ...
  if(theta>270&&theta<=315)  //  IVth Quad
  {
    enable_right=vmax;
    enable_left=vmax;
    enable_front=((vmax-180)*tan((theta-270)*3.14/180))+180;
    enable_back=((vmax-180)*tan((theta-270)*3.14/180))+180;
    inp1_front=1;
    inp2_front=0;
    inp1_back=0;
    inp2_back=1;
  ...
  if(theta>315&&theta<=360)  //  IVth Quad
  {
    enable_front=vmax;
    enable_back=vmax;
    enable_right=((vmax-180)*tan((360-theta)*3.14/180))+180;
    enable_left=((vmax-180)*tan((360-theta)*3.14/180))+180;
    inp1_front=1;
    inp2_front=0;
    inp1_back=0;
    inp2_back=1;
