...
float* turn(float legYin, float supLegYin, float veloYin, float veloYfi, float legZin, float supLegZin, float veloZin, float veloZfi, float zMax,float legRotin, float legRotfi, float supLegRotin, float supLegRotfi, Leg *leg, Leg *revLeg, Communication *comm, Imu *imu)
{
	...
	while(TRUE)
	{
		...
		if(Flag_moving_local==1)
		{
			...
			{	
				...
				if(theta<0&&flag==1)
				{
				state = dribble(state[YR],state[Y],state[YV],state[YV],state[ZR],state[Z],-state[ZV],state[ZV],0,0,0,0,bot.right_leg,bot.left_leg,comm);
				x=x+state[Y]-state[YR];
				flag=1-flag;
				}
				else if(theta>0&&flag==0)
				{
				state = dribble(state[YR],state[Y],state[YV],state[YV],state[ZR],state[Z],-state[ZV],state[ZV],0,0,0,0,bot.left_leg,bot.right_leg,comm);
				x=x+state[Y]-state[YR];
				flag=1-flag;	
				}
				while(theta1>10)
				{
					if(theta>0)
					{
						if(flag==0)
						{
							state = turn(state[YR],state[Y],state[YV],vTTar,state[ZR],state[Z],-state[ZV],state[ZV],0,10,0,0,bot.left_leg,bot.right_leg,comm);
							flag=1-flag;
							state = turn(state[YR],state[Y],state[YV],vTTar,state[ZR],state[Z],-state[ZV],state[ZV],state[RR],0,state[R],0,bot.right_leg,bot.left_leg,comm);
							flag=1-flag;
						}
						else if(flag==1)
						{
							state = turn(state[YR],state[Y],state[YV],vTTar,state[ZR],state[Z],-state[ZV],state[ZV],0,10,0,0,bot.right_leg,bot.left_leg,comm);
							flag=1-flag;
							state = turn(state[YR],state[Y],state[YV],vTTar,state[ZR],state[Z],-state[ZV],state[ZV],state[RR],0,state[R],0,bot.left_leg,bot.right_leg,comm);
							flag=1-flag;
						}
					}
					else if(theta<0)
				...
				while(x<r1)
				{
					if(flag==0)
						{
							state = dribble(state[YR],state[Y],state[YV],vTTar,state[ZR],state[Z],-state[ZV],state[ZV],0,10,0,0,bot.left_leg,bot.right_leg,comm);
							flag=1-flag;
							x=x+state[Y]-state[YR];
							state = dribble(state[YR],state[Y],state[YV],vTTar,state[ZR],state[Z],-state[ZV],state[ZV],state[RR],0,state[R],0,bot.right_leg,bot.left_leg,comm);
							flag=1-flag;
							x=x+state[Y]-state[YR];
						}
						else if(flag==1)
						{
							state = dribble(state[YR],state[Y],state[YV],vTTar,state[ZR],state[Z],-state[ZV],state[ZV],0,10,0,0,bot.right_leg,bot.left_leg,comm);
							flag=1-flag;
							x=x+state[Y]-state[YR];
							walk_dist1=state[Y]-state[YR];
							
							state = dribble(state[YR],state[Y],state[YV],vTTar,state[ZR],state[Z],-state[ZV],state[ZV],state[RR],0,state[R],0,bot.left_leg,bot.right_leg,comm);
							flag=1-flag;
							x=x+state[Y]-state[YR];
