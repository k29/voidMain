...
class baseVal
{
	...
	float *time;
	bool fFrame;
	baseVal(Walk *walk_object,float height,float *time)
	{
...
class motion
{
	...
	motion(Walk *walk_object, int leg, int axis, float magnitude, float startTime, float runTime,  int curveType, float startPhase, float endPhase, float *time)
	{
		this->walk_object=walk_object;
...
//		
//	}
//	walk5(flag,-STEP,0,STEP,0,0,0,0,0,0