...
float* dribble1(int leg, float legYin, float supLegYin, float veloYin, float veloYfi, float legZin, float supLegZin, float veloZin, float veloZfi)
{
	...
	float D_dsp1Time = 0.00;
	float D_dsp2Time = 0.00;
	float veloZNS    = veloZfi + (veloZfi + veloZin)/2;
...
int main()
{
	...
	dribble1(flag,0,0,0,0,lZin,slZin,vZin,vZfi);
	for(m=0;m<7;m++)
		dribble1(flag,0,0,0,0,-0.3294,-0.3294,vZin,vZfi);

	state = dribble(flag,0,0,0,0,-0.3294,-0.3294,vZin,vZfi);
	//lipm_generatorSSP(flag, 0, 0.010, -0.01 ,0.75);
	flag=1-flag;
	while(!kbhit2())
	{
		state = dribble(flag,0,0,0,0,state[ZR],state[Z],-state[ZV],state[ZV]);
//		usleep(16670*2);	
		flag=1-flag;
