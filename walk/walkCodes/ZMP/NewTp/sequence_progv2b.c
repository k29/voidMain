			...
			*/
			...
			if(phase_z==2)
			{
				...
				if(touchdown>5)
				{
					...
					newx=xset-min( (xr*(SINUS*SINUS + (1-COSY)*COSY)) , 100);
					newz=zset+(2*leg-1)*xset*fabs(SINUS*COSY - (1-COSY)*SINUS);
					// add_x=0.6*add_z;
			...
			// land_angle[1]=1.0*current_angle[1]*1023/180;
			feet_orient[0]=1.0*current_angle[0]*1023/180;
			feet_orient[1]=1.0*current_angle[1]*1023/180;
		}
		else if(sequence==2)
		{
