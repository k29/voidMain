...
#define serialusb2d "A7003N1d" //"A600cBa7" //"A600cURy"  //"A900fC5U"//nd USB2D: A7003N1d  A7003NDp	 A7005LC8	  A700eST2
...
/*void set_offset()
{
	if(acyut==4)
	{
		...
		offset[19]=0; 
		offset[20]=-6+10;
		offset[21]=334+15-25-20-40+10; 
		offset[22]=348-40-10;//-40; 
		offset[23]=248+70+75;//-20; 
		offset[24]=-2; 
		offset[25]=-15+7;//-7; 
		offset[26]=-306; 
		offset[27]= 0; 
...
/*void initialize_acyut()
{
	...
	for(i_init=0;i_init<NOM;i_init++)
	{
		...
		{
			value=1023-865+offset[tx_packet[7+i_init*3]];
			tx_packet[8+i_init*3]=value%256;
			tx_packet[9+i_init*3]=value/256;
			//printf("value %d \t %d\n",tx_packet[7+i_init*3],value);
		}
...
int main()
{
	...
	if(f!=NULL)
	{
		...
		fprintf(f,"plot \"errors\" with lines\n");
		fclose(f);
