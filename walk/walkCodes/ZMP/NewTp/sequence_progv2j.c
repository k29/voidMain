	...
	for(frame=0;walk_end==0;frame++)
	{
		...
		else if(sequence==1)
		{
			...
			*/
			...
			// land_angle[0]=1.0*current_angle[0]*1023/180;
			// land_angle[1]=1.0*current_angle[1]*(1-2*leg)*1023/180;
		...
		if(step_down && !firsttime && !set_land)
		{
			z=newz;
			x=newx;
		}
