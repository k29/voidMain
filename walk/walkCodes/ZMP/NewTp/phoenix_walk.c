...
// #define D2R (3.14/180)
 ...
 #define serialusb2d "A900fDhp" //"A600cBa7" //"A600cURy"  //"A900fC5U"//nd USB2D: A7003N1d  A7003NDp	 A7005LC8	  A700eST2
...
#define COM_STAND 407.5
#define COM_TRANS 402
#define COM_LOW   310
#define LSWAY 50    
#define LMASS 1499 
#define TMASS 2735
...
int initialize_acyut()
{
	...
	float *fval;
	int value;
	fval=generateik(COM_STAND,-HSTEP,seperation,0);
	for(h=0;h<5;h++)
	{	
		val[h]=fval[h];
	 	printf("val: %f \n", val[h]);
