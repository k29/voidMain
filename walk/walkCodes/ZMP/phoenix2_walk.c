...
#define COM_STAND 400//sqrt(LLENGTH*LLENGTH-HSTEP*HSTEP-seperation*seperation)-1 //406
#define COM_TRANS 390
#define COM_LOW   370
#define LEG_HIGH 330
#define LSWAY 50    
#define LMASS 1499 
...
int main()
{
	...
	initialize_acyut();
	//imucal_init();
	walk3(1-flag,-30,0,0,-30,0,0,0,0,0,0,0,0);
	usleep(16670*10);
	
	while(!kbhit2())
	{
		//printf("%d\n",read_position(5));
		walk3(flag,-HSTEP,0,0,-HSTEP,0,0,0,0,0,0,0,0);
		flag=1-flag;
		usleep(16670*15);
