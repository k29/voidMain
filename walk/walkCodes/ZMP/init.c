...
#define serialusb2d //"A900fDpz"//"A700eSSZ" //"A600cBa7" //"A600cURy"  //"A900fC5U"//nd USB2D: A7003N1d  A7003NDp	 A7005LC8	  A700eST2
...
void set_offset()
{
	...
	{
		offset[0]=15;
		offset[1]=350-25-20-30+7; 
		offset[2]=275;//-40 
		offset[3]=225;//'232;//-15;    // 142s  
		offset[4]=0; 
		offset[5]=-15-30;//+7; 
		offset[6]=346-40; 
		offset[7]=0; 
		...
		offset[19]=0; 
		offset[20]=-6;
		offset[21]=334+15-25-20-30+7; 
		offset[22]=288;//-40; 
		offset[23]=225;//248;//-15;//+25;//-20; 
		offset[24]=-10; 
		offset[25]=-15;//-7; 
		offset[26]=-306; 
		offset[27]= 0; 
